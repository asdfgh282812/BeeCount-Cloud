...
const ERROR_KEYS: Record<string, string> = {
  ...
  TX_DELETE_INSTALLMENT_LINKED: 'error.TX_DELETE_INSTALLMENT_LINKED',
  TX_UPDATE_INSTALLMENT_LINKED: 'error.TX_UPDATE_INSTALLMENT_LINKED',
  TX_ALREADY_REFUNDED: 'error.TX_ALREADY_REFUNDED',
  TX_REFUND_CHAIN_FORBIDDEN: 'error.TX_REFUND_CHAIN_FORBIDDEN',
  DEBT_NOT_FOUND: 'error.DEBT_NOT_FOUND',
  DEBT_HAS_REPAYMENTS: 'error.DEBT_HAS_REPAYMENTS',
  INSTALLMENT_NO_OUTSTANDING_BALANCE: 'error.INSTALLMENT_NO_OUTSTANDING_BALANCE',
  INSTALLMENT_AMOUNT_EXCEEDS_BALANCE: 'error.INSTALLMENT_AMOUNT_EXCEEDS_BALANCE',
  INSTALLMENT_ACCOUNT_IS_GROUP_MEMBER: 'error.INSTALLMENT_ACCOUNT_IS_GROUP_MEMBER',
  CARD_REWARD_RULE_LOCKED: 'error.CARD_REWARD_RULE_LOCKED',
  // 授權金鑰(docs/LICENSE_KEYS.md):/license/activate 的錯誤碼 + 全域 402
  LICENSE_REQUIRED: 'error.LICENSE_REQUIRED',
  LICENSE_KEY_INVALID: 'error.LICENSE_KEY_INVALID',
  LICENSE_KEY_NOT_FOUND: 'error.LICENSE_KEY_NOT_FOUND',
  LICENSE_KEY_ALREADY_REDEEMED: 'error.LICENSE_KEY_ALREADY_REDEEMED',
  LICENSE_KEY_REVOKED: 'error.LICENSE_KEY_REVOKED'
}
